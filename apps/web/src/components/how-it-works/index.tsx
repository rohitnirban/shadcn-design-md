...
export const HowItWorks = () => {
  const tabs = [
    ...
    {
      title: "Pick a format. Copy or download",
      description:
    ...
    <Container className="border-divide border-x">
      <div className="flex flex-col items-center pt-16">
        ...
        <SubHeading as="p" className="mx-auto mt-6 max-w-lg">
          Decode happens client-side using the same algorithm shipped in the
          shadcn CLI. Output is byte-equivalent to <code>shadcn apply</code>.
        </SubHeading>
        {/* Desktop Tabs */}
