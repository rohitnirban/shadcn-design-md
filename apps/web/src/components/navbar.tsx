  ...
  return (
    <div className="relative flex items-center justify-between p-2 md:hidden">
      ...
      <button
        ...
        className="shadow-card flex size-6 flex-col items-center justify-center rounded-md"
...
const FloatingNav = ({
  ...
  return (
    <motion.div
      style={{ y }}
      className="shadow-card fixed inset-x-0 top-0 z-50 mx-auto hidden max-w-[calc(80rem-4rem)] items-center justify-between bg-white/80 px-2 py-2 backdrop-blur-sm md:flex xl:rounded-2xl dark:bg-neutral-900/80 dark:shadow-[0px_2px_0px_0px_var(--color-neutral-800),0px_-2px_0px_0px_var(--color-neutral-800)]"
    >
      <Logo />
      <div className="flex items-center gap-10">
        {items.map((item) => (
