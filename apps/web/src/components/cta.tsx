  ...
  return (
    <Container className="border-divide relative flex min-h-60 flex-col items-center justify-center overflow-hidden border-x px-4 py-4 md:min-h-120">
      ...
      <SectionHeading className="relative z-10 text-center lg:text-6xl">
        Open a preset. <br /> Click DESIGN.md.
      </SectionHeading>
      <p className="relative z-20 mt-4 max-w-md text-center text-gray-600 dark:text-neutral-300">
            ...
            return (
              ...
              >
                <div style={{ transform: `rotate(${-angleDeg}deg)` }}>
                  <div
                    className={cn(
                      "shadow-card flex size-14 items-center justify-center rounded-md bg-white dark:bg-neutral-950",
