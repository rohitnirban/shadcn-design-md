  ...
  return (
    <motion.div className="relative mx-auto mt-20 h-full max-h-70 min-h-40 w-[85%] rounded-2xl border-t border-gray-300 bg-white p-4 shadow-2xl dark:border-neutral-700 dark:bg-neutral-800">
      <motion.div
        ...
        className="shadow-card absolute -top-10 -right-10 z-20 flex w-40 shrink-0 flex-col items-start rounded-lg bg-white text-xs dark:bg-neutral-900"
      >
...
const AssistantMessage = ({
  ...
  return (
    <div className="flex gap-3 px-1">
      <div className="shadow-card flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-white text-xs font-medium text-white dark:bg-neutral-900">
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <stop offset="0.5" stopColor="#7DD000" />
  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        >
          <stop stopColor="var(--color-line)" />
          <stop offset="0.33" stopColor="#7DD000" />
          <stop offset="0.66" stopColor="#7DD000" />
          <stop offset="1" stopColor="var(--color-line)" />
        </motion.linearGradient>
      </defs>
    </svg>
